        ...
        <div class="widget" id="admin_login" style="height:auto; margin:auto;">
            ...
            <fieldset>
                    ...
                    <div class="formRow">
                        ...
                        <div class="loginInput"><input type="text" name="username" id="param_username" value="{if isset($_POST.username)} $_POST.username {/if}"></div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="loginControl">
                        <div style="color:red; font-weight: blod; text-align: center;">{form_error('login')}</div>
