{$user = getSession()}
<form class="form" id="form" action="" onsubmit="return validateFormAccount()" method="post">
                            ...
                            <div class="form-content"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <span style="color: red;">*</span>
                                        <input type="text" placeholder="Số điện thoại của bạn" id="sdt" value="{set_value('sdt')}" class="form-control"  name="sdt">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <span style="color: red;">*</span>
                                                <input type="text" class="form-control" id="lop" value="{set_value('lop')}" placeholder="Lớp hành chính của bạn"  name="lop">
                                                <div name="name_error" class="clear error">{form_error('lop')}</div>
                                            </div>
                                            <div class="col-lg-6">
                                                <label><b>Mã Sinh Viên: </b></label>
                                                <span style="color: red;">*</span>
                                                <input type="text" class="form-control" id="masv" value="{set_value('masv')}" placeholder="Mã sinh viên của bạn"  name="masv">
