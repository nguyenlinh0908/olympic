...
class Clist extends CI_Controller{
    ...
    public function xuatexcel($post)
    {
        ...
        $today = date("d/m/Y");
        $array_merge = array('A1:E1','A2:E2','A3:E3','A4:I4','A5:I5','A6:I6','A7:I7');
        $array_bold = array('A2','A3','A5','A6','A8:I8');
        ...
        $sheet->getStyle('A8:E'.($row-1))->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
        $sheet->getStyle('H8:I'.($row-1))->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
        foreach ($array_outborder as $cell){
            $sheet->getStyle($cell)->getBorders()->getOutLine()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
        }
        $array_column = array(
            'A' => 5,
            'B' => 5,
